...
/**
 * Implements the {@link BeanValidator} using the JSR303 - BeanValidation. This
 * implementation will be enable by vraptor when the hibernate validator classes
 * is locale in classpath. Based on {@link JSR303Validator}.
 * 
...
@RequestScoped
@Component
public class JSR303SequenceValidator implements SequenceBeanValidator {

	private static final Logger logger = LoggerFactory.getLogger(JSR303SequenceValidator.class);
	...
	public JSR303SequenceValidator(Localization localization, Validator validator, MessageInterpolator interpolator) {
